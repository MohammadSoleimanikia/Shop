...
export default function FeaturedProducts({ title, items }) {
    return (
        <section className="my-1 pb-5 flex flex-col items-center gap-5 border-b-2 border-slate-200">
            <h2 className="text-center uppercase text-4xl font-extrabold my-10">
                {title}
            </h2>
